...
public class ServiceBController {
    ...
    public String greeting(@PathVariable("id") Long id,
                           ...
                           @RequestParam("fastname") String fastname,
                           @RequestParam("age") Integer age) {
        return serviceA.sayHello(id, name, fastname,age);
    }
    ...
    @RequestMapping(value = "/{fastname}", method = RequestMethod.PUT)
    public String updateUser(@PathVariable("fastname") String fastname, @RequestBody User user)
    {
        return serviceA.updateUser(fastname, user);
    }
