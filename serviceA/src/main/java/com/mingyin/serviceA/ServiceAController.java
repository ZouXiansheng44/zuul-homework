...
public class ServiceAController implements ServiceAInterface {
    ...
    @Override
    public String sayHello(Long id, String name, String fastname, Integer age)
    {
        return "{'msg': 'hello, " + fastname + "'}";
    }
    ...
    @Override
    public String updateUser(String fastname, User user) {
        System.out.println("更新用户姓氏，fastname=" + fastname);
        return "{'msg': 'success'}";
    }
